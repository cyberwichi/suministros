        ...
        <div id="modalConfirmaBorrarCliente" class="modal bg-danger" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content  bg-warning">
                        ...
                        <div class="modal-body">
                            <h5>¿ESTA SEGURO DE QUERER BORRAR LOS DATOS DE ESTE PROVEEDOR?</h5>
...
export default {
    ...
    methods: {
        ...
        actualizarCliente(){
            axios.put('/api/proveedor/'+this.client.id, this.client).then(response=>{
                if (response.data=='ok'){
        ...
        deleteCliente(id){
            axios.delete('/api/proveedor/'+id).then(response=>{
                if (response.data=='ok') {
